import { Button, TextField, List, ListItem, ListItemText, ListItemButton, Checkbox } from "@mui/material";
    ...
    <div style={{ margin: "20px" }}>
      ...
      >
        <Button
          ...
          color="primary"
          onClick={() => {
            setMyList((prev) => [...prev, { text: addTxt, id: generateId(), isComplete: false }]);
            setAddTxt("");
          }}
        >
          Add
      ...
      <List sx={{ mt: 3 }}>
        {myList.map((item) => (
          <ListItem key={item.id}>
            ...
            <ListItemText primary={item.text} sx={{ textDecoration: item.isComplete ? "line-through" : "" }} />
